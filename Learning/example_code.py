...
n_turns = 100
final_lap = line.track(particles, num_turns=n_turns,
              turn_by_turn_monitor=True)

print('hi')
## Turn-by-turn data is available at:
x = line.record_last_track.x # Shape is (n_part, n_turns)
y = line.record_last_track.y # Shape is (n_part, n_turns)
...
plt.xlabel("Turn")
plt.ylabel("x [m]")
plt.title("Turn-by-turn evolution of x")
plt.show()
